import { useContext, createElement, useEffect, useState, useReducer } from 'react'
...
const SyncWrapper = ({
  ...
  return createElement(getSyncComponent(settingContext.setting?.integration as string), {
    opened,
