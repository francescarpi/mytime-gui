...
const TaskEdition = ({
  ...
  const submit = (e: any) => {
    e.preventDefault()
    if (!e.target.checkValidity() || !startIsValid || (task?.end && !endIsValid)) {
      return
    }
  ...
  const startIsValid = useMemo(() => !end || (start && end && start.isBefore(end)), [start, end])

  const endIsValid = useMemo(() => end && start && end.isAfter(start), [start, end])
                ...
                <TimePicker
                  ...
                  slotProps={{
                    textField: {
                      ...
                      helperText: !startIsValid && 'Start time must be before end time',
                    },
                  }}
                />
              </Grid>
                  ...
                  <TimePicker
                    ...
                    slotProps={{
                      textField: {
                        ...
                        helperText: !endIsValid && 'End time must be after start time',
                      },
                    }}
                  />
                </Grid>
